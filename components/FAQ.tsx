...
const groups = [
    ...
    faqs: [
      {
        ...
        a: "Один конфиг рассчитан на одно устройство. Нужно подключить больше — оформи отдельную подписку на каждое.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Как оплатить?",
        a: "Прямо в Telegram-боте: картой РФ по реквизитам или криптой (~$10). Сразу получаешь конфиг — без регистраций и лишних форм.",
      },
      {
