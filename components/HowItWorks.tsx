...
const steps = [
  {
    num: "01",
    title: "Открой бота",
    desc: "Нажми любую кнопку на странице — откроется @wireguard_easy_buy_bot в Telegram. Регистрация не нужна.",
  },
  {
    num: "02",
    title: "Выбери тариф и оплати",
    desc: "Месяц, 3 месяца или год — выбираешь период, оплачиваешь по реквизитам. Займёт пару минут.",
  },
  {
    num: "03",
